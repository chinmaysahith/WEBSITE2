...
import { workAreas, trustTools, faqs } from "./data";

export const metadata = {
  title: "Trust & Influence — APSLOCK",
  description:
...
const trustMarkets = [
  {
    ...
    items: ["DTC & eCommerce Brands", "Food & Beverage", "Beauty & Personal Care", "Health & Wellness", "Apparel & Fashion", "Home & Lifestyle"],
  },
  {
    title: "Venture-Backed & B2B Companies",
    items: ["SaaS & Software Companies", "Fintech & Financial Services", "HealthTech & MedTech", "Logistics & Operations", "Professional Services", "Agencies & Studios"],
  },
  {
    title: "Enterprise & Institutional Brands",
    items: ["Public Companies & IPO-Stage", "Financial Institutions", "Healthcare Networks", "Insurance & Risk", "Government & Public Sector", "Education & Non-Profit"],
  },
  {
    title: "Category-Creating Companies",
    items: ["Deep Tech & Emerging Platforms", "Climate & Sustainability", "Web3 & Digital Assets", "AI & Automation Platforms", "Biotech & Life Sciences", "Hard Tech & Hardware"],
  },
  {
    title: "Executive & Leadership Brands",
    items: ["Founders & CEOs", "C-Suite & Senior Leaders", "Board Members & Investors", "Authors & Keynote Speakers", "Policy & Government Leaders", "Academics & Researchers"],
  },
  {
    title: "Brands in Transition",
    items: ["Post-Acquisition & Merger", "Rebrands & Category Pivots", "IPO & Pre-IPO Stage", "Crisis Recovery", "Market Entry", "Leadership Transition"],
  },
];

export default function TrustInfluencePage() {
  return (
    <main className="flex-1 bg-[#F3F1ED] expertise-page">

      {/* ── 01 · HERO ─────────────────────────────────────────────────── */}
      <section className="relative min-h-[94svh] flex items-end overflow-hidden">
        <GrainBlobs variant="blush" intensity={0.14} animate={true} className="absolute inset-0 z-0 pointer-events-none" />
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 sm:pt-36 sm:pb-24">
          ...
          <Reveal delay={440} duration={900} distance={32}>
            <h2 className="text-[2rem] sm:text-5xl lg:text-6xl xl:text-[4.25rem] font-bold tracking-tight text-[#5A2A6E] leading-[1.04]">
              Authority earned before the first meeting.
            </h2>
          </Reveal>
          ...
          <Reveal delay={620} duration={800} distance={24}>
            <p className="mt-10 text-base sm:text-lg lg:text-xl text-[#6B5A7A] max-w-2xl leading-[1.7]">
              PR, thought leadership, and communications that compound over time.
              We build the reputation layer that earns trust before your sales team
              shows up — and keeps it after the toughest news cycle you&apos;ll face.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      {/* ── 02 · MARKETS WE SHAPE ─────────────────────────────────────── */}
      <MarketsWeShape markets={trustMarkets} />
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-22 pb-0">
          <Reveal delay={120} duration={900} distance={28}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.08] max-w-xl font-serif" style={{ color: "#EDE8DE" }}>
              Six disciplines. One authority layer.
            </h2>
          </Reveal>
          <Reveal delay={240} duration={800} distance={20}>
            <p className="mt-5 text-base leading-[1.7] max-w-lg" style={{ color: "#6E6E6E" }}>
              Every engagement draws from the same communications practice — each discipline delivered at full depth, not bundled as a line item.
            </p>
          </Reveal>
        </div>
            ...
            {workAreas.map((area, i) => {
              ...
              return (
                <div key={area.title} className={`group relative overflow-hidden px-8 py-10 sm:px-10 ${borderRight} ${borderBottom} cursor-default`}>
                  ...
                  <p className="absolute inset-x-8 sm:inset-x-10 top-1/2 -translate-y-1/2 text-[15px] sm:text-base leading-[1.75] text-[#C87090] opacity-0 translate-y-4 transition-all duration-500 ease-in-out group-hover:opacity-100 group-hover:translate-y-[-50%]">
                    {area.description}
                  </p>
                </div>
              );
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 pb-8">
          <div className="max-w-2xl">
            ...
            <Reveal delay={120} duration={900} distance={0}>
              <h2 className="font-display uppercase mt-5"
                style={{ fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 700, letterSpacing: "0.06em", lineHeight: 1.15, color: "#0D0D0D" }}>
            ...
            <Reveal delay={240} duration={800} distance={16}>
              <p className="mt-5 text-base text-[#6B5A7A] leading-[1.7]">
                The platforms we&apos;ve standardized on for monitoring, publishing, and managing reputation at scale — chosen for reliability, not novelty.
              </p>
            </Reveal>
          </div>
        </div>
        <Reveal delay={100} duration={900} distance={16} className="pt-4 pb-20 sm:pb-24">
          <ToolsMarquee tools={trustTools} />
        </Reveal>
      </section>
